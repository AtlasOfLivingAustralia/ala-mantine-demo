    ...
    <Stack my={15} gap={5}>
      ...
      <LiteratureCard>
        <Text>
          Eberhard, R., '
          <Anchor>
            Tasmanian emu (Dromaius novaehollandiae diemenensis ) at the Queen Victoria Museum and
            Art Gallery, Launceston: description, provenance, age
          </Anchor>
      ...
      <LiteratureCard>
        <Text>
          '
          <Anchor>
            Eastern equine encephalitis transmission to emus (Dromaius novaehollandiae) in Volusia
            County, Florida: 1992 through 1994.
          </Anchor>
          ', <i>Journal of the American Mosquito Control Association</i>, <b>12</b>, 3 Pt 1, 1996
        </Text>
      </LiteratureCard>
      <LiteratureCard>
        <Text>
