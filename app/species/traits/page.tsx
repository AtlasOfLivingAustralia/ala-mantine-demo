        ...
        <Grid gutter="xl">
          <GridCol span={4}>
            <Stack gap={10}>
              ...
              <Text>
                The trait data shown here are a selection from <Anchor>AusTraits</Anchor>, an
                open-source, harmonised database of Australian plant trait data, sourced from
                individual researchers, government entities (e.g. herbaria) or NGOs across
                Australia.
              </Text>
              <Text mb={30}>
                Traits vary in scope from morphological attributes (e.g. leaf area, seed mass, plant
                ...
                water-use efficiency.) <Anchor>Find out more</Anchor>
              </Text>
              <AusTraitsLogo />
            </Stack>
          </GridCol>
